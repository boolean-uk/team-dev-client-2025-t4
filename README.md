...
2. Make sure the `VITE_API_URL` environment variable in the `.env` file contains the URL of the server app on your machine
3. `npm ci` to install dependencies
4. `npm run dev` to run the app. The server must also be running on your machine
